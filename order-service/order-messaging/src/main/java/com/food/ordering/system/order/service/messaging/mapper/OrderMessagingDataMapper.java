...
public class OrderMessagingDataMapper {
    ...
    public PaymentRequestAvroModel orderCancelledEventToPaymentRequestAvroModel(OrderCancelledEvent orderCancelledCreatedEvent){
        Order order = orderCancelledCreatedEvent.getOrder();
        return PaymentRequestAvroModel.newBuilder()
                .setId(UUID.randomUUID().toString())
                .setSagaId("")
                .setCustomerId(order.getCustomerId().getValue().toString())
                .setOrderId(order.getId().getValue().toString())
                .setPrice(order.getPrice().getAmount())
                .setCreatedAt(orderCancelledCreatedEvent.getCreatedAt().toInstant())
    ...
    public PaymentResponse paymentResponseAvroModelToPaymentResponse(PaymentResponseAvroModel
        ...
        return PaymentResponse.builder()
                ...
                .sagaId(paymentResponseAvroModel.getSagaId()) //Used by SAGA
